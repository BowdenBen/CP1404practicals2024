...
def is_valid_password(password):
    ...
    if len(password) < MIN_LENGTH or len(password) > MAX_LENGTH: # ensure if either condition is met, FALSE is returned
        return False
    ...
    # Loop through each character in the password to count types
    ...
    # If special characters are required, check for them
