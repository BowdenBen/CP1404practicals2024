...
for i in range(11):  # for each instance in a range the size of 11
    print(f"2 ^ {i:2} is {2 ** i:4}") # each instance right-aligned in a field of 2, 2^(instance) right aligned in a field of 4
